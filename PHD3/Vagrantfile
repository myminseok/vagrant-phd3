...
HAWQ_ORIGINAL_AMBARI_PLUGIN="hawq-plugin-phd-1.2-99.tar.gz"
...
PHD_30 = ["AMBARI-1.7.1-87-centos6.tar.gz", "PHD-3.0.0.0-249-centos6.tar", "PADS-1.3.0.2-14421.tar.gz", "PHD-UTILS-1.1.0.20-centos6.tar", HAWQ_ORIGINAL_AMBARI_PLUGIN]
